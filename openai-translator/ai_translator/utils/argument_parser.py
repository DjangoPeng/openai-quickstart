...
class ArgumentParser:
    def __init__(self):
        ...
        self.parser.add_argument('--target_language', type=str, help='Target language of translate book.')
    ...
    def parse_arguments(self):
        ...
        if not args.target_language in ['Chinese', 'Japanese']:
            self.parser.error("--target_language must be Chinese or Japanese.")
